import { useRecipeSearchForm } from '@/components/features/contents/recipe/list/hooks/useRecipeSearchForm';
...
jest.mock('@/components/features/contents/recipe/list/utils/searchQuery', () => ({
