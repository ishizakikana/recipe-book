...
const meta: Meta<typeof RecipeDetailDialog> = {
    title: 'Components/Features/Recipe/Detail/RecipeDetailDialog',
...
export const Default: Story = {
    play: async () => {
        ...
        expect(dialog.getByText(mockRecipe.name)).toBeInTheDocument();
        expect(dialog.getByRole('region', { name: 'レシピコンテンツ' })).toBeInTheDocument();
